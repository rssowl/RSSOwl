 ...
 * @author bpasero
 */
public class SearchCleanUpTask extends AbstractCleanUpTask {

  public SearchCleanUpTask(SummaryModelTaskGroup group) {
    super(group);
  }
  ...
  public String getLabel() {
    return Messages.TASK_LABEL_SEARCH_CLEANUP;
  }
}