 ...
 * programmatic added actions like sharing news.
 *
 * @author bpasero
 */
public class ShareNewsHandler extends AbstractHandler {
  private final ShareProvider fProvider;

  /**
   * @param provider the {@link ShareProvider} to use.
   */
  public ShareNewsHandler(ShareProvider provider) {
    fProvider = provider;
  }
  ...
  public Object execute(ExecutionEvent event) {
    ...
    if (selection != null && !selection.isEmpty())
      Controller.getDefault().share(selection, fProvider);
